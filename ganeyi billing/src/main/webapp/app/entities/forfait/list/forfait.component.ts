...
import { EntityArrayResponseType, ForfaitService } from '../service/forfait.service';
...
export class ForfaitComponent implements OnInit {
  ...
  trackId = (_index: number, item: IForfait): string => this.forfaitService.getForfaitIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.forfaits = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IForfait[] | null): IForfait[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.forfaitService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
