...
describe('Resultat Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'resultat', component: ResultatComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.resultats?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
