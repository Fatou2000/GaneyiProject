...
/**
 * REST controller for managing {@link com.facturation.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    @GetMapping("/clients/facture/{id}")
    public ResponseEntity<Facture> getclientbilling(@PathVariable String id){
