...
public class RequestResource {
    ...
    public ResponseEntity<Request> updateRequest(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, request.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Request> partialUpdateRequest(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, request.getId()));
    }
